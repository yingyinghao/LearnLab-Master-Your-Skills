            ...
            >
              <div className="max-w-xl lg:max-w-3xl">
                ...
                <div className="mt-6 grid grid-cols-4 gap-2">
                  ...
                  <div className="col-span-4 sm:col-span-2">
                    <div class="w-auto py-2">
                      <button class="flex items-center p-4 bg-gray-900 hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200">
                        <img
                          class="mr-3 w-[20px]"
                          src="https://upload.wikimedia.org/wikipedia/commons/3/31/Apple_logo_white.svg"
                          alt=""
                        />
                        <span class="font-semibold leading-normal text-white">
                          Continue with Apple
                        </span>
                      </button>
                    </div>
